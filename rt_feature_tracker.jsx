...
const PHASES = [
  {
    ...
    features: [
      ...
      { id: "f10", name: "Behavior mastery detection (≤1 × 8)", status: "done", priority: "P1", category: "Clinical" },
      { id: "f11", name: "Monthly mastery report (admin)", status: "done", priority: "P1", category: "Clinical" },
      ...
      { id: "f28", name: "Digital signatures", status: "pending", priority: "P1", category: "Clinical", description: "RBT and/or parent sign session at end. Required by some insurers." },
